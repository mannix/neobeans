...
local c = require('neobeans.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "Search", { fg = c.bg, bg = c.light_blue })
  hl(0, "IncSearch", { fg = c.bg, bg = c.blue })
  ...
  -- Code
  hl(0, "Comment", { fg = c.light_gray, bg = 'NONE' })
  ...
  -- Quickscope
  hl(0, "QuickScopePrimary", { fg = '#e17373', bg = 'NONE', underline=true, })
  hl(0, "QuickScopeSecondary", { fg = '#96bddb', bg = 'NONE', underline=true, })

  -- Telescope
  hl(0, "TelescopeSelection", { fg = 'NONE', bg = c.dark_gray })
  hl(0, "TelescopeSelectionCaret", { fg = c.orange, bg = 'NONE' })
  hl(0, "TelescopeMatching", { fg = c.info, bg = 'NONE', bold=true, italic=true, })
  hl(0, "TelescopeBorder", { fg = c.light_gray, bg = 'NONE' })
  ...
  hl(0, "TelescopePromptCounter", { fg = c.fg, bg = 'NONE' })
  hl(0, "TelescopePreviewHyphen", { fg = c.fg, bg = 'NONE' })
  ...
  hl(0, "NvimTreeImageFile", { fg = c.dark_gray, bg = 'NONE' })
  ...
  hl(0, "NvimTreeExecFile", { fg = '#94b978', bg = 'NONE' })
  ...
  hl(0, "FocusedSymbol", { fg = 'NONE', bg = '#292929' })

  -- Notify
  hl(0, "NotifyERRORBorder", { fg = '#e17373', bg = 'NONE' })
  hl(0, "NotifyWARNBorder", { fg = '#ffb97b', bg = 'NONE' })
  hl(0, "NotifyINFOBorder", { fg = c.ui_blue, bg = 'NONE' })
  hl(0, "NotifyDEBUGBorder", { fg = c.gray, bg = 'NONE' })
  hl(0, "NotifyTRACEBorder", { fg = '#e1c0fa', bg = 'NONE' })
  ...
  -- Hop
  hl(0, "HopNextKey", { fg = '#96bddb', bg = 'NONE' })
  hl(0, "HopNextKey1", { fg = '#e1c0fa', bg = 'NONE' })
  hl(0, "HopNextKey2", { fg = '#fbdaff', bg = 'NONE' })
  hl(0, "HopUnmatched", { fg = c.gray, bg = 'NONE' })
  hl(0, "HopPreview", { fg = '#94b978', bg = 'NONE' })
